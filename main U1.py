...
# OBS: Com essa interação via console o a janela só será aberta após o 
# usuário digitar o nome e escolher a configuração do tabuleiro
#---------------------------------------------------------------------------------
...
# O nome do jogador será exibido ao lado do título do jogo na janela gráfica
#----------------------------------------------------------
...
if len(NOME_JOGADOR) > 21:                                          # U1 - Estruturas de controle: if: limitando o tamanho do nome
    NOME_DO_JOGO = "2048 - Jogador de nome longo"                   # U1 - Tipos de dados: strings; U1 - Variáveis e atribuições: Strings
else:
    NOME_DO_JOGO = "2048 - Jogador: " + NOME_JOGADOR                # U1 - Tipos de dados: strings; U1 - Variáveis e atribuições: Concatenando Strings
...
def desenhar_jogo():                                                # U3 - Funções: definição de função sem parâmetros
    ...
    #------------------------------------------------------
    legenda = [
        FONTE_PEQUENA.render("Modo U1 - Altere as variáveis no código", True, (150, 150, 150)),         # U3 - Estudo de caso (PyGame): renderizando instrução; U1 - Strings
        FONTE_PEQUENA.render("Q para sair", True, (150, 150, 150))                                      # U3 - Estudo de caso (PyGame): renderizando instrução; U1 - Strings
    ]            
...
while running:                                                                                          # U2 - Estruturas de controle: while: loop principal do jogo
    for event in pygame.event.get():                                                                    # U2 - Estruturas de controle: for: percorrendo eventos do pygame; U3 - Estudo de caso (PyGame)
        ...
        if event.type == pygame.KEYDOWN:                                                                # U1 - Estruturas de controle: if: verificando evento de tecla pressionada
            if event.key == pygame.K_q:                                                                 # U1 - Estruturas de controle: if: verificando se a tecla 'Q' foi pressionada
                running = False                                                                         # U1 - Variáveis e atribuições; U1 - Tipos de dados: booleanos
