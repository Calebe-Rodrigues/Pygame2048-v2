...
def desenhar_jogo(estado_de_jogo):                                          # U3 - Funções: definição com parâmetro
    ...
    # Título do jogo
    ##################
    titulo = FONTE_GRANDE.render("2048", True, COR_DO_TEXTO)                # U3 - Estudo de caso (PyGame): renderizando texto; U1 - Strings
    ...
    legenda = [                                                                     # U1 - Tipos de dados: listas: lista de superfícies de texto
        ...
        FONTE_PEQUENA.render("R para reiniciar", True, (150, 150, 150)),            # U3 - Estudo de caso (PyGame): renderizando instrução; U1 - Strings
    ]

    ############################################
    # Funções que escrevem as intruções na tela
    #############################################
    janela.blit(legenda[0], (tabuleiro_left, ALTURA_JANELA - 55))                   # U3 - Estudo de caso (PyGame): desenhando legenda; U1 - Listas: acesso por índice
    janela.blit(legenda[1], (tabuleiro_left, ALTURA_JANELA - 30))                   # U3 - Estudo de caso (PyGame): desenhando legenda; U1 - Listas: acesso por índice
...
def main():                                                                         # U3 - Funções: definição da função principal sem parâmetros
    ...
    pygame.display.set_caption("Pygame 2048")                                       # U3 - Estudo de caso (PyGame): definindo título da janela; U1 - Strings
    ...
    while running:                                                                  # U2 - Estruturas de controle: while: loop principal do jogo
        ...
        clock.tick(60)                                                              # U3 - Estudo de caso (PyGame): limitando FPS; U1 - Tipos de dados: números
